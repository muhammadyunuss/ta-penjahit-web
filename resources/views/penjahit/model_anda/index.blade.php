...
<h3 class="page-title">
    Model Anda &nbsp;&nbsp;
    <a href="{{route('modelandas.create')}}" class="btn btn-primary btn-sm">
      + TAMBAH MODEL ANDA
    </a>
</h3>
<div class="page-bar">
...
<tbody>
    ...
    <td>
        <ul class="nav nav-pills">
            <li >
                <button onclick="window.location='{{ route('modelandas.edit', $d->id) }}'" type="button" class="btn btn-success">Ubah</button>
            </li>
            <li>
                <form method="POST" action="{{route('modelandas.destroy' , $d->id)}}">
                    @method('DELETE')
                    @csrf
