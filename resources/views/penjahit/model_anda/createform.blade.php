...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{route('modelandas.create')}}">Tambah Model Anda</a>
        </li>
    </ul>
</div>
<!-- END PAGE HEADER-->
...
<div class="portlet">
		...
		<div class="portlet-body form">
			<form method="POST" action="{{ route('modelandas.store') }}" enctype="multipart/form-data">
			@csrf
				<div class="form-body">
                    <div class="mb-3">
                    ...
                    <div class="form-group">
						...
						<input type="text" class="form-control @error('nmModel') is-invalid @enderror" name="nmModel" value="{{ old('nmModel') }}" placeholder="Isikan nama model Anda">
						@error('nmModel')
							<div class="invalid-feedback" style="color:red">{{ $message }}</div>
						@enderror
					</div><br>
					<div class="form-group">
						...
						<input type="number" class="form-control @error('hrgModel') is-invalid @enderror" name="hrgModel" value="{{ old('hrgModel') }}"  placeholder="Isikan harga model Anda" min="0">
						@error('hrgModel')
							<div class="invalid-feedback" style="color:red">{{ $message }}</div>
						@enderror
					</div><br>
					<div class="form-group">
						...
						<textarea class="form-control @error('deskModel') is-invalid @enderror" name="deskModel" placeholder="Isikan deskripsi model Anda" rows="3">{{ old('deskModel') }}</textarea>
					</div><br>
                    <!-- <div class="form-group">
