...
<!-- <link rel="stylesheet" type="text/css" href="{{ asset('assets/plugins/bootstrap-fileinput/bootstrap-fileinput.css')}}"/>
...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/plugins/bootstrap-switch/css/bootstrap-switch.min.css')}}"/>
