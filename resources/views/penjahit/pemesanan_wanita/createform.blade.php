			...
			@csrf
				<div class="form-body">
                    ...
                    <div class="form-group">
						...
						<input type="number" step="any" class="form-control" name="pnjgKebayaPemesanan" value="{{ old('pnjgKebayaPemesanan') }}"  placeholder="Isi dengan angka" min="0">
					</div><br>
                    <div class="form-group">
						<label for="pnjgDressPemesanan">Panjang Dress</label>
						<input type="number" step="any" class="form-control" name="pnjgDressPemesanan" value="{{ old('pnjgDressPemesanan') }}"  placeholder="Isi dengan angka" min="0">
					</div><br>
                    <div class="form-group">
                    ...
                    <div class="form-group">
						...
						<input type="number" step="any" class="form-control" name="pnjgMukaPemesanan" value="{{ old('pnjgMukaPemesanan') }}"  placeholder="Isi dengan angka" min="0">
					</div><br>
                    <div class="form-group">
						<label for="pnjgBelakangPemesanan">Panjang Belakang</label>
						<input type="number" step="any" class="form-control" name="pnjgBelakangPemesanan" value="{{ old('pnjgBelakangPemesanan') }}"  placeholder="Isi dengan angka" min="0">
					</div><br>
                    <div class="form-group">
                    ...
                    <div class="form-group">
						...
						<input type="number" step="any" class="form-control" name="bwhTanganPemesanan" value="{{ old('bwhTanganPemesanan') }}"  placeholder="Isi dengan angka" min="0">
					</div><br>
                    <div class="form-group">
						<label for="lkrLeherPemesanan">Lingkar Leher</label>
						<input type="number" step="any" class="form-control" name="lkrLeherPemesanan" value="{{ old('lkrLeherPemesanan') }}"  placeholder="Isi dengan angka" min="0">
					</div><br>
                    <div class="form-group">
						<label for="cupDadaPemesanan">Cup Dada</label>
						<input type="number" step="any" class="form-control" name="cupDadaPemesanan" value="{{ old('cupDadaPemesanan') }}"  placeholder="Isi dengan angka" min="0">
					</div><br>
                    <div class="form-group">
						<label for="trnDadaPemesanan">Turun Dada</label>
						<input type="number" step="any" class="form-control" name="trnDadaPemesanan" value="{{ old('trnDadaPemesanan') }}"  placeholder="Isi dengan angka" min="0">
					</div><br>
                    <div class="form-group">
						<label for="pjgRokPemesanan">Panjang Rok</label>
						<input type="number" step="any" class="form-control" name="pjgRokPemesanan" value="{{ old('pjgRokPemesanan') }}"  placeholder="Isi dengan angka" min="0">
					</div><br>
                    <div class="form-group">
						<label for="pjgBawahPemesanan">Panjang Bawah</label>
						<input type="number" step="any" class="form-control" name="pjgBawahPemesanan" value="{{ old('pjgBawahPemesanan') }}"  placeholder="Isi dengan angka" min="0">
					</div><br>
                    <div class="form-group">
