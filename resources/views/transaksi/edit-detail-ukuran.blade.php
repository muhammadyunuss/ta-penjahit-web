            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" id="jumlah_baju_dengan_ukuran_yg_sama" name="jumlah_baju_dengan_ukuran_yg_sama" class="form-control" value="{{ $detailUkuran->jumlah_baju_dengan_ukuran_yg_sama }}" placeholder="Jumlah Baju ukuran yang sama" required>
                    </div>
                </div>
            </div>
            <div class="row">
