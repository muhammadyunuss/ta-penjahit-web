...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{route('daftar-pengiriman.edit', $data->id)}}">Ubah Daftar Pengiriman</a>
        </li>
    </ul>
</div>
<!-- END PAGE HEADER-->
...
<div class="portlet">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-reorder"></i> Ubah Daftar Pengiriman
			</div>
		</div>
		<div class="portlet-body form">
			<form method="POST" action="{{ route('daftar-pengiriman.update', $data->id) }}" enctype="multipart/form-data">
			@csrf
			@method("PUT")
				<div class="form-body">
                    <div class="mb-3">
